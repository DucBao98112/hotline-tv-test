...
import com.gc.waravi.views.dialogs.AuthDialogFragment
import com.gc.waravi.views.dialogs.OnAuthResponseListener
...
class RegisterFragment : BaseFragment<FragmentRegisterBinding>() {
    ...
    private fun registerPeer(id : String, authCode: String) {
        lifecycleScope.launch(Dispatchers.IO) {
            SkywayManager.ensureSkywayInit(requireContext()){
                ...
                if (isAvailable) {
                    val registerRes = authRepository.register(id, authCode)
                    if(registerRes != null){
    ...
    private fun registerId(){
        val authCode = PrefUtils.getAuthCode(requireContext())
        if (authCode.isEmpty()){
            showAuthDialog()
            return
        }
    ...
    private fun showAuthDialog(){
        ...
        dialog.setOnResultListener(object : OnAuthResponseListener {
            override fun onSuccess() {
                this@RegisterFragment.registerId()
            }
        ...
        dialog.show(childFragmentManager, "auth-dialog")
    }
